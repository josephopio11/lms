          ...
          <div className="space-y-4 ">
            <div>
              <div className="flex items-center gap-x-2">
                ...
                <h2 className="text-xl">Customise your <span className='font-bold underline text-purple-800'>{chapter.title}</span> chapter</h2>
              </div>
              {/* TODOL chapter title form */}
              <ChapterTitleForm
                initialData={chapter}
                courseId={params.courseId}
                chapterId={params.chapterId}
